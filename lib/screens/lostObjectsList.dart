...
class _LostObjectsList extends State<LostObjectsList> {
  ...
  void atualizarTela({String busca = ""}) {
    setState(
      () {
        _value = getValue(busca);
      },
    );
  }
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        suffixIcon: IconButton(
                          ...
                          onPressed: () {
                            atualizarTela(busca: _searchController.text);
                            _searchController.text = "";
                          },
                        ),
                        hintText: 'Pesquise por um objeto...',
...
Future<String> getValue(String busca) async {
  return api.requestLostObjectsList(busca);
}
