...
class API {
  ...
  Future<String> requestLostObjectsList(String token) async {
  ...
  Future<SimpleResponse> createUser(User user) async {
    logger(user.toJson());
  ...
  Future<SimpleResponse> sendImage(XFile? imagem, int id) async {
    ...
    var postHeaders = <String, String>{'Authorization': 'xyz'};
